...
class ConfigurationService:
    def __init__(self):
        self.conf_file = Path("./") / CONFIGURATION_FILE_NAME
        self._read_config()
    ...
    def _read_config(self):
        try:
            with self.conf_file.open(encoding="utf-8") as conf_file_handle:
    ...
    def _save_config(self):
        with self.conf_file.open("w", encoding="utf-8") as conf_file_handle:
